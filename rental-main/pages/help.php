...
<div class="container mt-5">
    ...
    <div class="row support-options">
        <div class="col-md-4 mb-4">
            <div class="support-option">
                ...
                <a href="tel:+31201234567" class="btn">+31 (0)20 123 4567</a>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="support-option">
        ...
        <div class="col-md-4 mb-4">
            <div class="support-option">
                ...
                <a href="mailto:info@rydr.nl" class="btn">info@rydr.nl</a>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-5">
        <div class="col-md-6">
            <div class="help-section">
                <div class="contact-info">
                    <h5><i class="fas fa-map-marker-alt"></i>Adres</h5>
                    <p>Rydr Autoverhuur<br>
                    Voorbeeldstraat 123<br>
                    1234 AB Amsterdam</p>

                    <h5><i class="fas fa-phone"></i>Telefoon</h5>
                    <p><a href="tel:+31201234567">+31 (0)20 123 4567</a></p>

                    <h5><i class="fas fa-envelope"></i>E-mail</h5>
                    <p><a href="mailto:info@rydr.nl">info@rydr.nl</a></p>

                    <h5><i class="fas fa-clock"></i>Openingstijden</h5>
        ...
        <div class="col-md-6">
            <div class="help-section">
                <h2 class="help-title">Hoe Werkt Het?</h2>
                <div class="row">
                    <div class="col-md-6">
    ...
    <div class="row mt-5">
        <div class="col-12">
            <div class="help-section">
                <h2 class="help-title">Veelgestelde Vragen</h2>
